...
(** *** Definition of domination *)
 ...
 Definition IDom (g:G.t) (v1 v2: V) : Prop :=
   SDom g v1 v2 /\ ~ (exists v3, SDom g v1 v3 /\ SDom g v3 v2).
...
Module Type Algdom (Import G:GRAPH).
  ...
  Declare Module N : UsualDecidableType with Definition t := V.
  Declare Module NS : FSetInterface.WS with Module E:=N.
...
(* FOLD *)
  Proof.
    ...
    right. destruct (N.eq_dec v2 n1). subst. inversion H1; intuition.
    apply IHPath; auto.
